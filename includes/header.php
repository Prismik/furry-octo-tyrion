...
<html>
	<head>
		...
		<nav class="nav-header">
			<a href="index.php">
				<svg class="logo fbLogo svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				     width="64px" height="64px" viewBox="0 0 32 32" enable-background="new 0 0 32 32" xml:space="preserve">
				<circle class="circle" cx="16" cy="16" r="16" fill="#28CA81" />
				<g id="Letters">
					<g id="B">
			...
			<div class="menu-bar">
				...
				<ul class="menu">
					<li><a id="mail" 		href="mailto:info@francisbeauchamp.com" rel="nofollow">Email Me</a></li>
